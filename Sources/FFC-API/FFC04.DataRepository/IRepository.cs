...
namespace FFC04.DataRepository
{
        ...
        where TEntity : class, IData<T>, new()
    {
        ...
        Task<Other> GetOtherByIdAsync<Tid,Other>(Tid id) where Other : class, IData<Tid>, new();
        Task<Other> GetOtherAsync<Tid, Other>(Expression<Func<Other, bool>> predicate) where Other : class, IData<Tid>, new();
        Other GetOther<Tid, Other>(Tid id) where Other : class, IData<Tid>, new();
        /// <summary>
        ...
        /// <returns></returns>
        Task<ResultData<TEntity>> GetBySelectAsync(int pageNum, int pageSize, Expression<Func<TEntity, bool>> predicate);
        Task<ResultData<Other>> GetOtherBySelectAsync<Tid, Other>(int pageNum, int pageSize, Expression<Func<Other, bool>> predicate) where Other : class, IData<Tid>, new();
        Task<ResultData<Other>> GetAllOther<Tid,Other>(Expression<Func<Other, bool>> predicate) where Other : class, IData<Tid>, new();
        #endregion
        #region 4. 入库的方法
        /// <summary>
        ...
        Task<Result> AddTOherAsync<Tid,TOher>(TOher oher) where TOher : class, IData<Tid>, new();
        #endregion
        #region 5. 更新库存对象的方法
        /// <summary>
        ...
        Task<Result> UpdateTOherAsync<Tid,TOher>(TOher oher) where TOher : class, IData<Tid>, new();
        #endregion
        ...
        Task<Result> DeleteRangeAsync(List<TEntity> ids);
