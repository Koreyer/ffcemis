<template>
  <div class="scroll-y">
    <!--操作-->
    <div class="mr-3 rowSS" style="padding:5px ">
    ...
    >
      ...
      <el-table-column align="center" prop="name" label="商品类型" width="140" />
      <el-table-column align="center" prop="imageId" label="商品类型图片" min-width="100">
...
let deleteByIdReq = (id) => {
  return axiosReq({
    url: '/CommodityBusiness/CommodityType/SoftDeleteById',
    data: { id: id },
    isParams: true,
    method: 'delete',
    bfLoading: true
